...
VALUES
  (
    ...
    TRUE,
    NULL,
    '72753dd4-956d-42c8-9d51-06a6c89f532b',
  ...
  (
    ...
    NULL,
    '72753dd4-956d-42c8-9d51-06a6c89f532b',
    'Le casque audio Sennheiser HD 660 S offre une qualité sonore exceptionnelle et un confort optimal. Grâce à ses transducteurs haute performance et à sa conception ouverte, il vous permet de profiter de votre musique préférée avec une clarté et une précision incroyables. De plus, il est doté d"un design léger et confortable, idéal pour une utilisation prolongée'
  );
...
VALUES
  (
    ...
    TRUE,
    NULL,
    '81313d61-33ba-459c-b4c9-6cd1ad4f1adb',
  ...
  (
    ...
    NULL,
    '81313d61-33ba-459c-b4c9-6cd1ad4f1adb',
    'Le téléphone intelligent Apple iPhone 11 offre une expérience mobile exceptionnelle avec un écran Liquid Retina HD de 6,1 po et un appareil photo à double objectif de 12 Mpx. Profitez d"une performance fluide et d"une autonomie prolongée grâce à la puce A13 Bionic et à la batterie longue durée. De plus, il est doté d"un design élégant et durable qui résiste à l"eau et à la poussière.'
  );
...
VALUES
  (
    ...
    TRUE,
    NULL,
    '548bcd71-6109-40dc-b98b-9670c2e9c1e8',
  ...
  (
    ...
    NULL,
    '548bcd71-6109-40dc-b98b-9670c2e9c1e8',
    'La tablette Samsung Galaxy Tab A 8 po 32 Go offre une expérience mobile exceptionnelle avec un écran WXGA de 8 po et un appareil photo de 8 Mpx. Profitez d"une performance fluide et d"une autonomie prolongée grâce à la puce Snapdragon 429 et à la batterie longue durée. De plus, elle est dotée d"un design élégant et durable qui résiste à l"eau et à la poussière.'
  );
