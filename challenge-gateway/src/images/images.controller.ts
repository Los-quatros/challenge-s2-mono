...
export class ImagesController {
  ...
  async uploadImage(@UploadedFile() file: any, @Param() type : string, @Param() idRessource : string): Promise<any> {
    ...
    const savedImage = await this.imagesService.uploadImage(file, new ImagesAssociatedOn(idRessource['id'],associationType));
    return savedImage;
  }
